(function (window, plat) {
    var SchUtils = window.SchUtils = {};

    SchUtils.Canshow2 = function (field, code) {
        if (field) field = field.toLowerCase();
        if (typeof code === 'object') code = code.SchFtype || code.schFtype || code.schftype;
        return Can_Show2(code, field, plat);
    };

    function can_show_with_plat(defVal, plat) {
        var platVals = Array.prototype.slice.call(arguments, 2);
    ...
    // from '学校详情字段表-开发版v3 2020.11.25.xlsx'
    function Can_Show2(code, field, plat) {
        switch (field) {
            case "学校英文名":
            case "s.name_e":
                {
