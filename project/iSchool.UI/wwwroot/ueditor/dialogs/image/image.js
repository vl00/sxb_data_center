        ...
        initUploader: function () {
            ...
            function addFile(file) {
                var $li = $('<li id="' + file.id + '">' +
                    ...
                    $title = $('<p class="title">' + file.name + '</p>').appendTo($li),
                ...
                $li.on('mouseenter', function () {
                    ...
                    $title.stop().animate({ height: 24 });
                });
                $li.on('mouseleave', function () {
                    $btns.stop().animate({ height: 0 });
                    $title.stop().animate({ height: 0 });
                });
                ...
                //绑定左移事件;
                $li.find('.moveLeft').on('click', function () {
                    leftLi($(this).parents('li').prev(), $(this).parents('li'));
                });

                //绑定右移事件;
                $li.find('.moveRight').on('click', function () {
                    var curParentLi = $(this).parents('li').index();
                    var len = $(this).parents('.filelist').find('li').length;
                    if (curParentLi + 2 === len) {
                        return;
                    }
                    rightLi($(this).parents('li').next(), $(this).parents('li'));
                });
            }
