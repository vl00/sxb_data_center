...
namespace iSchool.Infrastructure.Repositories
{
    ...
    public class BaseRepository<Tentiy> : IRepository<Tentiy> where Tentiy : class
    {
        ...
        {
            return Connection.Get<Tentiy>(id, transaction: Transaction);
        }
        ...
        {
            return Connection.Query<Tentiy>(GetAllSql(), new { }, transaction: Transaction);
        }
        ...
        public IEnumerable<Tentiy> GetAll(Expression<Func<Tentiy, bool>> expression)
        {
            ...
            return Connection.Query<Tentiy>(sql, Parameters, transaction: Transaction);
        }
        ...
        public bool IsExist(Expression<Func<Tentiy, bool>> expression)
        {
            ...
            return Connection.Query<int>(query, Parameters, transaction: Transaction).FirstOrDefault() > 0;
        }
        ...
        public Tentiy Get(Expression<Func<Tentiy, bool>> expression)
        {
            ...
            return Connection.QueryFirstOrDefault<Tentiy>(query, Parameters, transaction: Transaction);
        }
        ...
        {
            return Connection.Query<Tentiy>(IsValidSql(), new { objId = objId }, transaction: Transaction).FirstOrDefault();
        }
        ...
        {
            return Connection.Query<Tentiy>(GetFiledSql(filed), new { filed = value }, transaction: Transaction).FirstOrDefault();
        }
        ...
        {
            return Connection.Query<Tentiy>(GetFiledListSql(filed), new { filed = value }, transaction: Transaction);
        }
        ...
        public IEnumerable<Tentiy> GetListByFileds(Dictionary<string, string> fileds)
        {
            ...
            return Connection.Query<Tentiy>(GetFiledsListSql(fileds), parameters, transaction: Transaction);
        }
        ...
        {
            return Connection.Query<Tentiy>(InArraySql(field), new { array = array }, transaction: Transaction);
        }
